...
// fun A::x [verification] at ./sources/A.move:2:5+39
procedure {:timeLimit 40} $cafe_A_x$verify() returns ($ret0: int)
{
    ...
    // $t0 := 0xcafe at ./sources/A.move:2:31+11
    assume {:print "$at(23,53,64)"} true;
    $t0 := 51966;
    assume $IsValid'address'($t0);

    // trace_return[0]($t0) at ./sources/A.move:2:31+11
    assume {:print "$track_return(0,0,0):", $t0} $t0 == $t0;

    // label L1 at ./sources/A.move:2:43+1
L1:

    // return $t0 at ./sources/A.move:2:43+1
    $ret0 := $t0;
    return;
